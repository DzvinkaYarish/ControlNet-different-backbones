...
def get_args():
    ...
    parser.add_argument('--model_config', type=str, default='cldm_lite_conv.yaml') # for sd: cldm_v15.yaml, for mlp: cldm_lite_mlp.yaml, for conv: cldm_lite_conv.yaml
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(accelerator='cpu', gpus=0, precision=32,
                               default_root_dir=exp_path, max_steps=config['max_steps'], max_time=config['max_time'])
    # Train!
